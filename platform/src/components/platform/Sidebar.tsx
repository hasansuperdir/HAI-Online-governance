...
const navItems = [
  ...
  { href: "/platform/correspondence", label: "Correspondence", icon: "✉️" },
  { href: "/platform/documents", label: "Documents", icon: "📄" },
  { href: "/platform/drawings", label: "Drawings", icon: "📐" },
  { href: "/platform/bim", label: "BIM / Models", icon: "🧊" },
  { href: "/platform/approvals", label: "Approvals", icon: "✅" },
  { href: "/platform/submittals", label: "Submittals", icon: "📨" },
  { href: "/platform/commercial", label: "Commercial", icon: "💰" },
  { href: "/platform/schedule", label: "Schedule", icon: "📅" },
  ...
  { href: "/platform/observations", label: "Observations", icon: "👁️" },
  { href: "/platform/punchlist", label: "Punch List", icon: "📌" },
  { href: "/platform/hse", label: "HSE", icon: "⚠️" },
  { href: "/platform/dailylog", label: "Daily Log", icon: "📝" },
  { href: "/platform/photos", label: "Site Photos", icon: "📷" },
  { href: "/platform/meetings", label: "Meetings", icon: "🗓️" },
  { href: "/platform/authority", label: "Authority", icon: "🏛️" },
  { href: "/platform/directory", label: "Directory", icon: "👥" },
